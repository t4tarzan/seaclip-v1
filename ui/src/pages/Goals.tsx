...
function ProgressBar({ metricType, metricCurrent, metricTarget }: Pick<Goal, "metricType" | "metricCurrent" | "metricTarget">) {
  ...
  const pct = target > 0 ? Math.min(100, Math.round(((metricCurrent ?? 0) / target) * 100)) : 0;
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 8, flex: 1, maxWidth: 160 }}>
      <div style={{ flex: 1, height: 6, backgroundColor: "var(--bg-alt)", borderRadius: 0, overflow: "hidden" }}>
        <div
  ...
  return (
    <div>
      <div
        ...
        style={{ display: "flex", alignItems: "center", gap: 8, padding: "10px 12px", borderRadius: 0, marginLeft: depth > 0 ? 24 : 0 }}
      >
        {hasChildren ? (
          <button
        ...
        <div className="bg-[var(--primary)]/15 border border-[var(--primary)]/25" style={{ width: 28, height: 28, borderRadius: 0, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
        ...
        <span className={cn("text-[10px] font-medium px-2 py-0.5 rounded-none", colors.bg, colors.text)}>
          {colors.label}
        </span>
        {goal.targetDate && (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div>
            ...
            <textarea
              ...
              style={{ backgroundColor: "var(--bg-alt)", border: "1px solid var(--border)", borderRadius: 0, padding: "8px 12px", resize: "none" }}
              rows={3}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 12 }}>
            <div>
              ...
              <select
                ...
                style={{ backgroundColor: "var(--bg-alt)", border: "1px solid var(--border)", borderRadius: 0, padding: "8px 12px" }}
                value={status}
